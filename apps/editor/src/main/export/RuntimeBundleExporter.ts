...
export const PLAYER_COMPATIBILITY = ">=13 <14";
...
function parseSavedAuthorProjectEnvelope(
  ...
  if (
    ...
    throw new Error("document 字段不符合作者项目 v22");
  }
...
function compileSavedAuthorProject(
  ...
  // v22 compiler and are compared with expectedAssets below.
...
async function copyAssetAndHash(
  ...
  // Author assets have no trusted digest in the saved v22 document. Treat even
